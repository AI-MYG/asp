...
echo ""
echo "Next — dev acceptance (example):"
echo "  cd $REPO_ROOT"
echo "  bash scripts/run_accept.sh pass --issue <N> --repo AI-MYG/asp-backend"
echo ""
echo "Docs: docs/onboarding_inbound_skills.md"
echo "Cursor: open this folder as workspace to load .cursor/skills/"
