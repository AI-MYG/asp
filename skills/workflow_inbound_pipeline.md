...
bash scripts/run_accept.sh pass --issue <N> --repo <repo>
```

详见 [Dev Acceptance](./workflow_acceptance.md) 与 [组员最小环境](../docs/onboarding_inbound_skills.md)。Legacy 人测 gate 见 [Human Gate](./workflow_human_gate.md)。
